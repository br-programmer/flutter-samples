    ...
    return ValueListenableBuilder(
      ...
      builder: (_, status, __) {
        if (musicPlayerBloc.musicPlayer.loading) {
          return CircleAvatar(
              radius: 25, backgroundColor: MusicAppColors.bluePurple, child: CupertinoActivityIndicator());
            ...
            builder: (_, value, __) {
              return GestureDetector(
                ...
                child: CircleAvatar(
                  ...
                  backgroundColor: MusicAppColors.bluePurple,
                  child: AnimatedIcon(
                      icon: AnimatedIcons.play_pause, progress: _controller, color: Colors.white, size: 30),
                ),
              );
            },
          );
