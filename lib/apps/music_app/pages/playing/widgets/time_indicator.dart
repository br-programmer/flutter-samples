...
class __IndicatorState extends State<_Indicator> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      musicPlayerBloc.musicPlayer.position.addListener(() {
        if (_dragging == false) {
          _sliderValue.value = musicPlayerBloc.musicPlayer.position.value.inSeconds.toDouble();
        }
      });
    });
    super.initState();
  ...
  @override
  Widget build(BuildContext context) {
    final musicPlayer = Provider.of<MusicPlayerBLoC>(context, listen: false).musicPlayer;
        ...
        return Column(
          ...
          children: [
                  ...
                  ShaderMask(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(image: Image.asset('assets/images/music_app/waveform.png').image),
                      ),
                    ),
                  ),
                  AbsorbPointer(
            ...
            ValueListenableBuilder(
              ...
              builder: (_, position, __) => _IndicatorTime(percent: value / max, text: '- ${formatTime(position)}'),
            ),
          ],
        );
      },
...
class _IndicatorTime extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.translate(
      ...
      child: Container(
        decoration: BoxDecoration(color: MusicAppColors.bluePurple, borderRadius: BorderRadius.circular(5)),
