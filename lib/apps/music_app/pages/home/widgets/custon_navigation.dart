    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: MusicAppColors.secondary, borderRadius: BorderRadius.vertical(top: Radius.circular(25))),
        padding: const EdgeInsets.symmetric(horizontal: 10),
        child: Row(children: items.map((e) => _ItemNavigation(path: e, index: items.indexOf(e))).toList()),
      ),
    );
  }
}
...
class _ItemNavigation extends StatelessWidget {
  const _ItemNavigation({Key key, @required this.index, @required this.path}) : super(key: key);
          ...
          child: Container(
            ...
            child: ValueListenableBuilder<int>(
              ...
              builder: (_, value, __) => AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: (index == value) ? MusicAppColors.bluePurple : Colors.transparent,
