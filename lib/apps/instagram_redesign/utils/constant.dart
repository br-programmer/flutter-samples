...
const items = <String>[
  ...
  'assets/images/instagram_redesign/logo_instagram.svg',
...
const hastags = <String>['#Mobile', '#Flutter', '#Android', '#iOS', '#Sunsets'];

const info = '📱 Mobile Developer 💻 Ing. Sistema 🥰 - Manta, Ecuador';

const selectCategory = <String>['Post', 'Etiquetas', 'IGTV'];
