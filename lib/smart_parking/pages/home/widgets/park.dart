...
import 'package:flutter_samples/smart_parking/models/parker.dart';
...
class ItemPark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      alignment: isRight ? Alignment.bottomRight : isSelected ? Alignment.center : Alignment.bottomLeft,
      child: isFull
